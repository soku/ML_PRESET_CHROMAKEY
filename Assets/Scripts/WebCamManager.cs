...
namespace OpenCvSharp
{
	public class WebCamManager : MonoBehaviour
	{
		...
		/// </summary>
		private Unity.TextureConversionParams ReadTextureConversionParameters()
		{
			...
			parameters.FlipHorizontally = IsFrontFacing();
		...
		public virtual Mat GetMat()
		{
			...
			frameMat = Unity.TextureToMat(webCamTexture, ReadTextureConversionParameters());
		...
		protected virtual void CancelInitCoroutine()
		{
			if (initCoroutine != null)
			{
				...
				((System.IDisposable)initCoroutine).Dispose();
				initCoroutine = null;
			}
		}
